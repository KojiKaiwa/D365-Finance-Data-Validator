...
- ・Developed an AI-driven Customer Ticket Triage System to automate priority and sentiment analysis
- ・Enhanced AI triage with automated sorting and action-suggestion logic for support teams
